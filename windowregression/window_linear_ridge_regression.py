...
from .widget_linear_regression import WidgetLinearRegression
from .widget_ridge_regression import WidgetRidgeRegression
from .widget_right_side_bar import WidgetRightSideBar

import numpy as np
import random

class WindowLinearRidgeRegression(QtWidgets.QWidget):
    def __init__(self) -> None:
        super().__init__()

        self.setWindowTitle("General Graphing Software - Linear/Ridge Regression")
        ...
        self.widget_linear_regression = WidgetLinearRegression(self)
        self.widget_ridge_regression = WidgetRidgeRegression(self)
